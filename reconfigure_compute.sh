...
if [ x$2x == xx ];
 then
  echo "usage: reconfigure_openstack_compute.sh controller_address local_address"
  exit 1
fi
...
echo "--------------------------------"
echo " Assuming all packages are already installed! "
...
cp /etc/neutron/plugins/ml2/linuxbridge_agent.ini /etc/neutron/plugins/ml2/linuxbridge_agent.prev
